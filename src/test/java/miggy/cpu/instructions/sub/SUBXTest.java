...
// $Revision: 21 $
class SUBXTest extends BasicSetup {
    @Test
    void testByte() {
        ...
        assertEquals(0x123456ff, SystemModel.CPU.getDataRegister(0), "Check result");
    ...
    void testLong() {
        ...
        assertEquals(0x8acf1356, SystemModel.CPU.getDataRegister(0), "Check result");
        assertTrue(SystemModel.CPU.isSet(CpuFlag.X), "Check X");
        assertTrue(SystemModel.CPU.isSet(CpuFlag.N), "Check N");
        assertFalse(SystemModel.CPU.isSet(CpuFlag.Z), "Check Z");
        assertTrue(SystemModel.CPU.isSet(CpuFlag.V), "Check V");
